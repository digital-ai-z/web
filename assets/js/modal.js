...
if (modal && modalContent && closeModal) {
  ...
  document.querySelectorAll('[data-modal="impressum"]').forEach((el) => {
    el.addEventListener('click', (e) => handleOpen(e, 'impressum'));
  });

  document.querySelectorAll('[data-modal="datenschutz"]').forEach((el) => {
    el.addEventListener('click', (e) => handleOpen(e, 'datenschutz'));
  });
